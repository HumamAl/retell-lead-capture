...
export const APP_CONFIG = {
  appName: "LeadFlow",                              // Display name (sidebar header, page title)
  projectName: "Retell Lead Capture Pipeline",      // Client's product name (tab bar microtext, footer)
  clientName: "Dean" as string | null,              // Client first name, or null — never render "null"
  domain: "construction",                           // Domain (construction / trades)
